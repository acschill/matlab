...
% calc calc function
[x1,y1] = canon_shell_projectile_noResistance_calc(dt,vi,30);
[x2,y2] = canon_shell_projectile_noResistance_calc(dt,vi,theta);
[x3,y3] = canon_shell_projectile_noResistance_calc(dt,vi,40);
[x4,y4] = canon_shell_projectile_noResistance_calc(dt,vi,45);
[x5,y5] = canon_shell_projectile_noResistance_calc(dt,vi,50);
[x6,y6] = canon_shell_projectile_noResistance_calc(dt,vi,55);
